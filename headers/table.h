 ...
 * looking up values that correspond to a given key. It does this by storing two lists - one for the keys, and another
 * for the values. When an item is added, the index of its key in the key list corresponds to the index of its value in
 * the value list.
