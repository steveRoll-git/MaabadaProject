 ...
 *
 * @param input_file_path The path to the .as file to be preprocessed.
 * @param output_file_path The path to the .am file where the output will be written to.
 * @param macro_table The macro table where defined macros will be stored.
